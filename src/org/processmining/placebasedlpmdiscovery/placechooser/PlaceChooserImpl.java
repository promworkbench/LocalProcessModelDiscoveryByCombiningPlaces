...
public class PlaceChooserImpl implements PlaceChooser {
    ...
    public PlaceChooserImpl(PlaceChooserParameters parameters, Set<Place> places, XLog log, LEFRMatrix lefr) {
