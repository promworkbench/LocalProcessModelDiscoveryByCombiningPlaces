...
//
//        // create the result
//        WindowsEvaluationResult result = new WindowsEvaluationResult(lpm, windowSize, this.evaluationLog.getMapping().getLabelMap());
//
//        // map transitions in the lpm into integers
//        Set<Integer> mappedLpmTransitions = lpm.getTransitions()
//                .stream()
//                .map(x -> this.evaluationLog.getMapping().getLabelMap().get(x.getLabel()))
//                .collect(Collectors.toSet());
//
//        // setup replayer
//        Replayer replayer = new Replayer(lpm, this.evaluationLog.getMapping().getLabelMap());
//
...
//        this.evaluationLog.getMapping().addInvisibleTransitionsInLabelMap(lpm.getTransitions()
//                .stream()
