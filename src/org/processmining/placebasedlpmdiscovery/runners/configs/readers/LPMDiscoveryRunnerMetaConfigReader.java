...
import org.processmining.placebasedlpmdiscovery.runners.lpmdiscovery.LPMDiscoveryRunnerConfig;
...
public class LPMDiscoveryRunnerMetaConfigReader implements RunnerMetaConfigReader<LPMDiscoveryRunnerConfig> {

    @Override
    public RunnerMetaConfig<LPMDiscoveryRunnerConfig> readConfig(String configFilePath) throws FileNotFoundException {
        ...
        return gson.fromJson(
                ...
                new TypeToken<RunnerMetaConfig<LPMDiscoveryRunnerConfig>>() {}.getType()
        );
    }
}
