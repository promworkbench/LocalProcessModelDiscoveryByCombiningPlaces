...
import org.processmining.placebasedlpmdiscovery.runners.clustering.ClusteringRunnerConfig;
...
public class ClusteringRunnerMetaConfigReader implements RunnerMetaConfigReader<ClusteringRunnerConfig> {
    @Override
    public RunnerMetaConfig<ClusteringRunnerConfig> readConfig(String configFilePath) throws FileNotFoundException {
        ...
        RunnerMetaConfig<ClusteringRunnerConfig> config = gson.fromJson(
                new FileReader(configFilePath),
                new TypeToken<RunnerMetaConfig<ClusteringRunnerConfig>>() {
                }.getType()
        );
        return config;
    }
